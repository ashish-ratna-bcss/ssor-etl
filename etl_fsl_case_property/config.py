...
DB_CONFIG = {
    **resolve_db_config(),
    'connect_timeout': get_int_env('DB_CONNECT_TIMEOUT', 30),
    'keepalives': get_int_env('DB_KEEPALIVES', 1),
...
API_CONFIG = {
    ...
    'fsl_case_property_url': get_api_endpoint('fsl_case_property', '/case-property'),
}
